...
Desde o Go 1.26 dá para encontrar essas gorrotinas. O perfil `goroutineleak`, do pacote `runtime/pprof`, lista as que estão bloqueadas em um canal ou mutex que nenhuma gorrotina viva alcança. É experimental, atrás de `GOEXPERIMENT=goroutineleakprofile`, e aparece também em `/debug/pprof/goroutineleak`. Para ir mais fundo em `context`, veja [este repositório](https://github.com/cassiobotaro/contexto) e a segunda metade do artigo sobre [_pipelines_](https://go.dev/blog/pipelines).
